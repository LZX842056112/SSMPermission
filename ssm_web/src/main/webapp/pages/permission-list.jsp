                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a href="${pageContext.request.contextPath}/pages/permission-add.jsp" type="button" class="btn btn-default" title="新建"><i class="fa fa-file-o"></i> 新建</a>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfo.pages}" var="item">
                                <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${item}&size=${pageInfo.pageSize}">${item}</a></li>
                            </c:forEach>
                            <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">下一页</a></li>
                            <li>
